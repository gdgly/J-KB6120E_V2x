	...
	do
	{
		...
		switch( item )
		{
			case 1:
				...
				if ( EditI16U( 0x0818u, &gray, 0x0401u ))
				{
					if ( gray > 1000u )
					{
						gray = 1000u;
	...
	do
	{
		...
		switch( item )
		{
			case 1:
				...
				else if( ++ Configure.PumpType[SP_R24_A] > 2 )
			...
			case 2:
				...
				else if( ++ Configure.PumpType[SP_R24_B] > 2 )
...
void	HCBoxPIDParament( void )
{
	...
	do
	{
		...
		{
			case 1:
				EditI16U( 0x0618, &PID.Kp, 0x0400 );
				changed = TRUE;
				break;
			case 2:
				EditI16U( 0x0918, &PID.Ti, 0x0502 );
				changed = TRUE;
				break;
			case 3:
				EditI16U( 0x0C18, &PID.Td, 0x0502 );
				changed = TRUE;
				break;
