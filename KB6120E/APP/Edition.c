...
//   Lputs( 0x0808u, szNameIdent[Configure.InstrumentName] );
	...
	Lputs( 0x1209u, "编号:" );
	ShowFP32( 0x1212u, Configure.ExNum, 0x0700u, NULL );
}
static	void	ShowEdition_NoName2( void )
{
	...
	Lputs( 0x1609u, "编号:" );
	ShowFP32( 0x1612u, Configure.ExNum, 0x0700u, NULL );
}
...
static	void	ShowEdition_HasName2( void )
{
	...
	Lputs( 0x1809u, "编号:" );
	ShowFP32( 0x1812u, Configure.ExNum, 0x0700u, NULL );
}
...
void	ConfigureLoad_KB6120C( void )
{
	...
	Configure.SetFlow[SP_TSP  ]  = 1000u;
	Configure.Pr_Portect[SP_TSP  ]  =  500u; 		//	粉尘  采样流量 100.0	L/m		限压值	  5KPa

	Configure.PumpType[SP_R24_A] = enumOrifice_1;
	Configure.SetFlow[SP_R24_A]  =  	2u;
	Configure.Pr_Portect[SP_R24_A]  = 1000u;		//	日均1 采样流量 0.200	L/m		限压值	 10KPa

	Configure.PumpType[SP_R24_B] = enumOrifice_1;
	Configure.SetFlow[SP_R24_B]  =  	2u;
	Configure.Pr_Portect[SP_R24_B]  = 1000u;		//	日均2 采样流量 0.200	L/m		限压值	 10KPa

	Configure.PumpType[SP_SHI_C] = enumOrifice_1;
	Configure.SetFlow[SP_SHI_C]  =  	5u;
	Configure.Pr_Portect[SP_SHI_C]  = 1000u;		//	时均1 采样流量 0.5 	L/m		限压值	 10KPa

	Configure.PumpType[SP_SHI_D] = enumOrifice_1;
	Configure.SetFlow[SP_SHI_D]  =  	5u;
	Configure.Pr_Portect[SP_SHI_D]  = 1000u;		//	时均2 采样流量 0.5 	L/m		限压值	 10KPa
...
void	ConfigureLoad_KB6120B( void )
{
	...
	Configure.PumpType[SP_TSP  ] = enumOrifice_1;
	Configure.SetFlow[SP_TSP  ]  = 1000u;	//	粉尘  采样流量 100.0 L/m
	Configure.PumpType[SP_R24_A] = enumPumpNone;
	Configure.SetFlow[SP_R24_A]  =  2u;	//	日均1 采样流量 0.200 L/m
	Configure.PumpType[SP_R24_B] = enumPumpNone;
	Configure.SetFlow[SP_R24_B]  =  2u;	//	日均2 采样流量 0.200 L/m
	Configure.PumpType[SP_SHI_C] = enumOrifice_1;
	Configure.SetFlow[SP_SHI_C]  =  5u;	//	时均1 采样流量 0.5 L/m
	Configure.PumpType[SP_SHI_D] = enumOrifice_1;
	Configure.SetFlow[SP_SHI_D]  =  5u;	//	时均2 采样流量 0.5 L/m
...
void	ConfigureLoad_KB2400D( void )
{
	...
	Configure.PumpType[SP_TSP  ] = enumPumpNone;
	Configure.SetFlow[SP_TSP  ]  = 1000u;	//	粉尘 采样流量 100.0 L/m
	Configure.PumpType[SP_R24_A] = enumOrifice_1;
	Configure.SetFlow[SP_R24_A]  =  2u;	//	日均1采样流量 0.200 L/m
	Configure.PumpType[SP_R24_B] = enumOrifice_1;
	Configure.SetFlow[SP_R24_B]  =  2u;	//	日均2采样流量 0.200 L/m
	Configure.PumpType[SP_SHI_C] = enumOrifice_1;
	Configure.SetFlow[SP_SHI_C]  =  5u;	//	时均1采样流量 0.5 L/m
	Configure.PumpType[SP_SHI_D] = enumOrifice_1;
	Configure.SetFlow[SP_SHI_D]  =  5u;	//	时均2采样流量 0.5 L/m
...
void	ConfigureLoad_KB2400( void )
{
	...
	Configure.PumpType[SP_R24_B] = enumOrifice_1;
	Configure.SetFlow[SP_R24_B]  =  2u;	//	日均2采样流量 0.200 L/m
	Configure.PumpType[SP_SHI_C] = enumPumpNone;
	Configure.SetFlow[SP_SHI_C]  =  5u;	//	时均1采样流量 0.5 L/m
	Configure.PumpType[SP_SHI_D] = enumPumpNone;
	Configure.SetFlow[SP_SHI_D]  =  5u;	//	时均2采样流量 0.5 L/m
