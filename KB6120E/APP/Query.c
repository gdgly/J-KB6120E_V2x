...
// /*********************************************************************/
// static void FPrintf_R24(uint16_t FileNum, struct uFile_TSP_SHI_R24  const * pFile)
// {
// 	  static	struct uMenu  const  menu[] =
// 	{
// 		{ 0x0201u, "文件输出" },
...
// /***********************************************************************/
// static void FPrintf_SHI(uint16_t FileNum, struct uFile_TSP_SHI_R24  const * pFile)
// {
// 	  static	struct uMenu  const  menu[] =
// 	{
// 		{ 0x0201u, "文件输出" },
...
// 					break;
			...
			case opt_A_A1:
				...
				Lputs( 0x0E02u, "标况流量:" );	ShowFP32( 0x0E17u, File.vnd / File.sum_min, 		0x0403u, "L/m" );	
...
// 	FileNum = SampleSet[SP_SHI].FileNum;
// 	
// 	if (( FileNum < 1 ) || ( FileNum > FileNum_Max ))
// 	{
// 		beep();
...
// 				Lputs( 0x011Bu, "[1/3]" );
// 				Lputs( 0x0602u, "开始时间:" );	ShowDATE( 0x0610u, File.sample_begin );
// 				Lputs( 0x0C02u, "大气压力:" );	ShowFP32( 0x0C12u, File.sum_Ba         / File.sum_min[SamplerSelect], 0x0602u, "kPa" );
// 				Lputs( 0x1202u, "采样次数:" );	ShowI16U( 0x1216u, File.run_loops,   0x0200u, NULL );
// 				Lputs( 0x1802u, "设置次数:" );	ShowI16U( 0x1816u, File.set_loops,   0x0200u, NULL );
// 				
// 			
...
// 				Lputs( 0x0602u, "温   度:" );	ShowFP32( 0x0615u, File.sum_tr[SamplerSelect] / File.sum_min[SamplerSelect], 0x0402u, "℃" );
// 				Lputs( 0x0902u, "压   力:" );	ShowFP32( 0x0915u, File.sum_pr[SamplerSelect] / File.sum_min[SamplerSelect], 0x0402u, "kPa" );
// 				Lputs( 0x0C02u, "标况流量:" );	ShowFP32( 0x0C17u, File.vnd [SamplerSelect]   / File.sum_min[SamplerSelect], 0x0403u, "L/m" );
// 				Lputs( 0x0F02u, "设置流量:" );	ShowI16U( 0x0F17u, File.set_flow[SamplerSelect] * 100,               0x0403u, "L/m" );
// 				Lputs( 0x1202u, "体   积:" );	ShowFP32( 0x1213u, File.vnd[SamplerSelect],                          0x0602u, "L" );
// 				Lputs( 0x1502u, "采样时间:" );	ShowTIME( 0x1515u, File.sum_min[SamplerSelect]  );
// 				Lputs( 0x1802u, "设置时间:" );	ShowTIME( 0x1815u, File.set_time[SamplerSelect] );
// 				break;

// 			case opt_A2X_B1:
// 				Lputs( 0x0110u, "D" );Lputs( 0x011Bu, "[3/3]" );
// 				Lputs( 0x0602u, "温   度:" );	ShowFP32( 0x0615u, File.sum_tr[SP_SP2] / File.sum_min[SP_SP2], 0x0402u, "℃" );
// 				Lputs( 0x0902u, "压   力:" );	ShowFP32( 0x0915u, File.sum_pr[SP_SP2] / File.sum_min[SP_SP2], 0x0402u, "kPa" );	
// 				Lputs( 0x0C02u, "标况流量:" );	ShowFP32( 0x0C17u, File.vnd [SP_SP2]   / File.sum_min[SP_SP2], 0x0403u, "L/m" );
// 				Lputs( 0x0F02u, "设置流量:" );	ShowI16U( 0x0F17u, File.set_flow[SP_SP2] * 100,               0x0403u, "L/m" );
// 				Lputs( 0x1202u, "体   积:" );	ShowFP32( 0x1213u, File.vnd[SP_SP2],                          0x0602u, "L" );
// 				Lputs( 0x1502u, "采样时间:" );	ShowTIME( 0x1515u, File.sum_min[SP_SP2]  );
// 				Lputs( 0x1802u, "设置时间:" );	ShowTIME( 0x1815u, File.set_time[SP_SP2] );
// 				break;
// 			}
// 		}
// 		
...
// 			File_Load_SHI ( fname, &File );
// 			if( fname > SampleSet[SP_SHI].FileNum )
// 			{
// 				beep();//	到达最后，"后"面无有效数据
// 				File_Load_SHI ( FileNum, &File );
// 			}
...
// 	FileNum = SampleSet[SP_AIR].FileNum;
// 	if (( FileNum < 1 ) || ( FileNum > FileNum_Max ))
// 	{
// 		beep();
...
// 			File_Load_AIR ( fname, &File );
// 			if( fname > SampleSet[SP_AIR].FileNum )
// 			{
// 				beep();//	到达最后，"后"面无有效数据
// 				File_Load_AIR ( FileNum, &File );
// 			}
...
//		uint16_t	FileNum = SampleSet[SP_TSP].FileNum;
...
//		uint16_t	FileNum = SampleSet[SamplerSelect].FileNum;
...
//			Lputs( 0x0800u, "时间:" );		ShowDATE( 0x080Cu, File.sample_begin );
//			Lputs( 0x1000u, "压力A:" );		ShowFP32( 0x1011u, File.max_pr[SamplerSelect], 0x0602u, "kPa" );
//			Lputs( 0x1800u, "压力B:" );		ShowFP32( 0x0607u, File.max_pr[SP_SP2], 0x0602u, "kPa" );
...
//		} option = opt_standard;
//		struct	uFile_SHI	File;
//		uint16_t	FileNum = SampleSet[SP_SHI].FileNum;
...
//			Lputs( 0x0800u, "时间:" );		ShowDATE( 0x080Cu, File.sample_begin );
//			Lputs( 0x1000u, "压力C:" );		ShowFP32( 0x1011u, File.max_pr[SamplerSelect], 0x0602u, "kPa" );
//			Lputs( 0x1800u, "压力D:" );		ShowFP32( 0x0607u, File.max_pr[SP_SP2], 0x0602u, "kPa" );
...
void	menu_SampleQuery( void )	//enum enumSamplerSelect SamplerSelect )
{
	switch ( SamplerSelect )
	{
		...
		default:
			break;
// 	case SP_AIR:		Query_File_AIR();	break;
	}
}
