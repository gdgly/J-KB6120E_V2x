...
extern BOOL USBPrint_R24( uint16_t FileNum, struct uFile_TSP_SHI_R24 const * pFile );
extern BOOL USBPrint_SHI( uint16_t FileNum, struct uFile_TSP_SHI_R24 const * pFile );
